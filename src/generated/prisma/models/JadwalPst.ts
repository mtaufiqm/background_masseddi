...
// @ts-nocheck 
/*
 * This file exports the `JadwalPst` model and its related types.
 *
...
export type GetJadwalPstAggregateType<T extends JadwalPstAggregateArgs> = {
      [P in keyof T & keyof AggregateJadwalPst]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateJadwalPst[P]>
    : Prisma.GetScalarType<T[P], AggregateJadwalPst[P]>
}
...
type GetJadwalPstGroupByPayload<T extends JadwalPstGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<JadwalPstGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof JadwalPstGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], JadwalPstGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], JadwalPstGroupByOutputType[P]>
      }
    >
  >
...
export type JadwalPstCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<JadwalPstFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface JadwalPstDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['JadwalPst'], meta: { name: 'JadwalPst' } }
  /**
   ...
   * })
  **/
  count<T extends JadwalPstCountArgs>(
    args?: Prisma.Subset<T, JadwalPstCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], JadwalPstCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends JadwalPstGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, JadwalPstGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetJadwalPstGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
